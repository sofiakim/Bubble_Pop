...
/** The CorrectFourMain class - creates the JFrame for Connect Four
  * Plays a simple game of Connect 4 using ConnectFourBoard class
  * @author ICS3U
...
public class BubblePopMain extends JFrame implements ActionListener
{
	...
	setIconImage (Toolkit.getDefaultToolkit ().getImage ("penguinIcon.png"));
